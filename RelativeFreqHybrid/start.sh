...
JAR_FILE="target/RelativeFreqHybrid-1.0-SNAPSHOT.jar"
CLASS_NAME="edu.mum.bigdata.mo.RelFreqHybridDriver"
HADOOP_OUTPUT_FOLDER="/user/hive/warehouse/chd_hybrid_`date +'%Y%m%d%H%M%S'`"
